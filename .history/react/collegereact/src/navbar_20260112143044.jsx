    ...
    <nav className="align-center ">
      <div className=" justify-between bg-amber-200 flex-row flex flex-wrap py-1">
        ...
        <div className="align-center flex flex-row justify-around px-5 py-1 ">
          <div className="navelement flex-1 items-center bg-amber-400 px-4 mr-2 rounded-lg shadow-lg hover:bg-amber-500">
            <button className="p-2">
                Home
            </button>
          </div>
          <div className="navelement flex-1 px-5 items-center bg-amber-400 mr-2 rounded-lg shadow-lghover:bg-amber-500">
            <button className="p-2">
                About_Us
            </button>
          </div>
