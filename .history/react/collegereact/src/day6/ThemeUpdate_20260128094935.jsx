...
const ThemeUpdate = () => {
  const btnVariant = {
    "normal":"bg-blue-500 text-white px-4 py-2 rounded-lg shadow-md mx-2 my-2"
  }
  const [isDarkmode, setDarkmode] = useState(false);
  return (
    <div className='bg-amber-300 font-serif text-center items-center justify-center flex-col-reverse'>
      <div >
