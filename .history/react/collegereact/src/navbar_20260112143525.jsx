...
let Navbar = () => {
  return (
    <nav className="align-center ">
      <div className=" justify-between bg-amber-200 flex-row flex flex-wrap py-1 rounded-b-2xl">
        <div className="flex-1 ml-5 justify-center py-2  text-cyan-800 font-bold ">
