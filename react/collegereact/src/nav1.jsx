    ...
    <div className=' !p-8 !my-2 flex bg-amber-600 text-amber-100 justify-between items-center'>
      ...
      <div className='menus flex gap-6'>
        <div className='max-w-md mx-auto '>
            <input placeholder='Search Anything...' onChange={handleChangeOnsearch} className='w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all'/>
        </div>
        <h4 onClick={(e) => {
